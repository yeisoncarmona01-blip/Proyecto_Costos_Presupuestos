...
import com.denkitronik.softcostservice.domain.estimacion.EstimacionServiceException;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(EstimacionServiceException.class)
  public ResponseEntity<ApiErrorResponse> handleEstimacionServiceException(
    EstimacionServiceException ex) {
